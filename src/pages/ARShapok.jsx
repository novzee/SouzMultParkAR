...
// import neural network model for SHAPKA detection:
...
// Component for 3D model following the detected SHAPKA object
const ShapkaFollower = ({ onDetect, onLose }) => {
